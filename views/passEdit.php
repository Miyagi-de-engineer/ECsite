    ...
    <main class="form-signIn">
        <form action="" method="post">
            ...
            <div class="form-group">
                <label for="inputPass_old">古いパスワード<span class="ml-3 text-danger"><?php if (!empty($errMsg['pass_old'])) echo $errMsg['pass_old']; ?></span></label>
            ...
            <div class="form-group">
                <label for="inputPass_new">新しいパスワード<span class="ml-3 text-danger"><?php if (!empty($errMsg['pass_new'])) echo $errMsg['pass_new']; ?></span></label>
                <input type="password" name="pass_new" id="inputPass_new" class="form-control mb-3" placeholder="半角英数字の6文字以上で入力">
            </div>

            <div class="form-group">
                <label for="inputPass_Re">パスワード（再入力）<span class="ml-3 text-danger"><?php if (!empty($errMsg['pass_re'])) echo $errMsg['pass_re']; ?></span></label>
