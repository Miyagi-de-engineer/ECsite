<div class="container text-center" style="margin-bottom: 120px;">
    <main class="form">
        <form action="#" method="post">
            <h1 class="h3 text-dark my-3">お気に入り・登録商品一覧</h1>
            <!-- お気に入り -->
            <p class="h5 text-left mb-2">お気に入り一覧</p>
            <div class="row">
            ...
            <div class="h5 text-muted text-left my-3">お気に入り登録なし</div>
        <?php endif; ?>

        <!-- 登録した商品 -->
        <p class="h5 text-left mb-2">登録した商品</p>
        <div class="row">
