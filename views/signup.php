    ...
    <main class="form-signIn">
        <form action="" method="post">
            ...
            <div class="form-group">
                <label for="inputEmail">E-mail<span class="ml-3 text-danger"><?php if (!empty($errMsg['email'])) echo $errMsg['email']; ?></span></label>
            ...
            <div class="form-group">
                <label for="inputPass">Password<span class="ml-3 text-danger"><?php if (!empty($errMsg['pass'])) echo $errMsg['pass']; ?></span></label>
                <input type="password" name="pass" id="inputPass" class="form-control mb-3" placeholder="パスワード">
            </div>

            <div class="form-group">
                <label for="inputPassRetype">Password_Retype<span class="ml-3 text-danger"><?php if (!empty($errMsg['pass_re'])) echo $errMsg['pass_re']; ?></span></label>
